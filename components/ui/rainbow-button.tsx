  ...
  return (
    <button
      ...
      className={cn(
        ...
        // Glass effect
        "bg-white/10 backdrop-filter backdrop-blur-3xl shadow-2xl drop-shadow-2xl",
         // light mode colors
        "bg-,linear-gradient(#121213_50%,rgba(18,18,19,0.6)_80%,rgba(18,18,19,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
        // dark mode colors
